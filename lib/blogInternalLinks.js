...
const LINK_RULES = [
  ...
  },
  {
    ...
    excludeSlugs: ['best-omegle-alternatives-2026', 'omegle-alternatives-why-parvah-is-better', 'what-replaced-omegle-in-2026'],
    max: 1,
  },
  {
    pattern: /\badult Omegle\b/gi,
    href: '/blog/adult-omegle-free-no-signup',
    excludeSlugs: ['adult-omegle-free-no-signup'],
    max: 1,
  },
  {
    pattern: /\bNSFW video chat\b/gi,
    href: '/blog/nsfw-video-chat-with-strangers-18-plus',
    excludeSlugs: ['nsfw-video-chat-with-strangers-18-plus'],
    max: 1,
  },
  {
  ...
  {
    pattern: /\bchat with girls\b/gi,
    href: '/chat-with-girls',
    max: 1,
  },
  {
    pattern: /\bvideo chat with girls\b/gi,
    href: '/video-chat-with-girls',
    max: 1,
  },
  {
    pattern: /\bgirls video chat\b/gi,
    href: '/girls-video-chat',
    max: 1,
  },
  {
    pattern: /\bdirty talk(?: video chat)?\b/gi,
    href: '/dirty-talk-video-chat',
    max: 1,
  },
  {
    pattern: /\btalk to strangers\b/gi,
    href: '/talk-to-strangers',
    max: 1,
  },
  {
    pattern: /\blive video chat\b/gi,
    href: '/live-video-chat',
    max: 1,
  },
  {
