...
export default function AgeGate({ onConfirm }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/90 backdrop-blur-md p-4">
      <div className="max-w-md w-full p-8 rounded-3xl bg-white shadow-2xl space-y-6 text-center ring-1 ring-slate-200">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-rose-600 to-red-600 text-white font-black text-2xl flex items-center justify-center shadow-lg">
          18+
        </div>
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="w-full py-3.5 rounded-xl font-black text-sm text-white bg-gradient-to-r from-indigo-600 via-purple-600 to-rose-500 hover:from-indigo-700 hover:via-purple-700 hover:to-rose-600 shadow-lg transition active:scale-95"
          >
